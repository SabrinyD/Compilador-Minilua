...
## Project Information
- **Project path**: /home/sabriny-dantas/Área de trabalho/Compilador-Minilua
- **Working branch**: appmod/java-upgrade-20260121163906
...
- **Target JDK path (Java 21)**: /usr/lib/jvm/java-21-openjdk-amd64/bin
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20260121163906`.
